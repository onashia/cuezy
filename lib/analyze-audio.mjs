 ...
 */
export function normalizeAnalysisRequest(inputPathOrUrl, options = {}, requestOptions = {}) {
...
export async function analyzeAudio(inputPathOrUrl, options = {}, callbacks = {}) {
  try {
    const request = normalizeAnalysisRequest(inputPathOrUrl, options, { requireLocalFile: true });
